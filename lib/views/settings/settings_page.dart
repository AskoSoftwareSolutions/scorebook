          ...
          child: ListView(
            ...
            children: [
              ...
              _SettingsTile(
                ...
                onTap: () async {
                  final url =
                  Uri.parse('https://yourapp.com/terms'); // ← replace
              ...
              _SettingsTile(
                ...
                onTap: () async {
                  final url =
                  Uri.parse('https://yourapp.com/privacy'); // ← replace
                  if (await canLaunchUrl(url)) launchUrl(url);
                },
              ),
              ...
              Center(
                child: Column(
                  children: [
                    ...
                    Text(
                      '© ${DateTime.now().year} Cricket Scorer. All rights reserved.',
                      style: const TextStyle(
